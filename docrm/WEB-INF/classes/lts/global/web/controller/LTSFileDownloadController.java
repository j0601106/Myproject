...
@Controller
@Scope("prototype")
@RequestMapping({"/global/LTSFileDownloadController.do"})
public class LTSFileDownloadController
  extends LTSController
{
  ...
  public void processFileDownload(RequestBean requestBean, ResponseBean responseBean, HttpServletResponse response)
    throws Exception
  {
