...
var urlAction = {
	...
	,processQuery     : "../DOCRM810M_Controller.do?command=processQuery"
	,processDelete     : "../DOCRM810M_Controller.do?command=processDelete"
};
...
//   			_edit		: "<span class='btn-edit' onclick=\"processEdit({PKNO:'@{PKNO}'})\"></span>"
			...
			,columnMeta : [
				...
				,{ title:'編號', index:'MANDATE_NO' ,dataAttr:"style='text-align:center'"}
				,{ title:'稅目別', index:'TAX' ,dataAttr:"style='text-align:center'"}
				,{ title:'主旨', index:'SUBJECT' ,dataAttr:"style='text-align:center'"}
				,{ title:'建立日期', indexPattern : '@{CREATE_DATE}'+'&nbsp;'+'@{CREATE_TIME}' ,dataAttr:"style='text-align:center'"}
