...
<%
String PROGRAM_CD	= "DOCRM240M_";
String SCREEN_CD	= "DOCRM240M_01";
...
layout.setBreadCrumb("附件下載(DOCRM240M_)", "一般", true);
...
var urlAction = {
	 processMain         	: "../DOCRM240M_Controller.do?command=processMain"
	,processQuery        	: "../DOCRM240M_Controller.do?command=processQuery"
	,processDownload        : "../DOCRM240M_Controller.do?command=processDownload"
};
...
function processDownload(NM,PATH) {
  	formUtil.download({'FILE_PATH':PATH,'FILE_NM':NM}, urlAction.processDownload);
}
