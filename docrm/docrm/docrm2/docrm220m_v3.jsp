...
var urlAction = {
		 processQueryDetail4         : "../DOCRM220M_Controller.do?command=processQueryDetail4"
};
...
function processQueryDetail4(jsonResult){
	...
	$('#DOCRM_NO').html(jsonResult.DOCRM_NO);
	...
	var options = {
			 dataObj : jsonResult
			,url : urlAction.processQueryDetail4
			,gridObj : $('#tableGrid')
			,columnMeta : [
