...
//	String ipInfo = request.getLocalAddr()  + "\r\n, " + request.getLocalName();
	...
	defaultLayout.addPortlet("queryBlock", true, StringUtil.ifNull(thePage.getProperty("page.queryBlockTitle"), "查詢"), true, true);
	defaultLayout.addPortlet("listBlock", true, StringUtil.ifNull(thePage.getProperty("page.listBlockTitle"), "查詢結果"), true, false);
	defaultLayout.addPortlet("editBlock", true, StringUtil.ifNull(thePage.getProperty("page.editBlockTitle"), "編輯"), true, false);
...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/decorators/template_1_1_main.js"></script>
