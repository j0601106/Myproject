...
<%
	...
	/** 功能名稱 / 機密等級 */
//	無拿掉 String programInfo = program.get("PROGRAM_NM") + "(" + program_cd + "/" + screen_cd + ")";

	String programInfo =  "(" + program_cd + "/" + screen_cd + ")";
//	String ipInfo = request.getLocalAddr()  + "\r\n, " + request.getLocalName();
	...
	defaultLayout.addPortlet("queryBlock", true, StringUtil.ifNull(thePage.getProperty("page.queryBlockTitle"), "查詢"), true);
	defaultLayout.addPortlet("listBlock", true, StringUtil.ifNull(thePage.getProperty("page.listBlockTitle"), "查詢結果"),	true);
...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/decorators/template_1_2_main.js"></script>
